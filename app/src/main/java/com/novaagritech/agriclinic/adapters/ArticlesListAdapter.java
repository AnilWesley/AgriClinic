...
public class ArticlesListAdapter extends RecyclerView.Adapter<ArticlesListAdapter.ViewHolder>{
    ...
    public ArticlesListAdapter(Context ctx, List<InfoData> dataModelList) {
    ...
    @NonNull
    @Override
    public ArticlesListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent,
                                                             int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);

        @SuppressLint("InflateParams") View view = inflater.inflate(R.layout.articlelayout2,null);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        ImageLoader.getInstance()
                .displayImage(Urls.IMAGE_URL +infoData.getImage_path(), holder.imageView, options,
