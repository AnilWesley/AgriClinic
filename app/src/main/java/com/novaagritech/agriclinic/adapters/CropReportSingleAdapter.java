...
public class CropReportSingleAdapter extends RecyclerView.Adapter<CropReportSingleAdapter.NameHolder>
{

    private Context context;
    CropReportSingleAdapter adapter;
    private List<ReportDetails> list;
    private DisplayImageOptions options;


    public CropReportSingleAdapter(Context context, List<ReportDetails> list) {
