...
public class HomeActivity1 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener , ForceUpdateChecker.OnUpdateNeededListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* CurvedBottomNavigationView curvedBottomNavigationView = findViewById(R.id.bottom_view);
        ...
        fm.beginTransaction().replace(R.id.main_container, termsFragment, "9").hide(termsFragment).commit();
        fm.beginTransaction().replace(R.id.main_container, helpFragment, "8").hide(helpFragment).commit();
        fm.beginTransaction().replace(R.id.main_container, aboutFragment, "7").hide(aboutFragment).commit();
        fm.beginTransaction().replace(R.id.main_container, searchMArticlesFragment, "6").hide(searchMArticlesFragment).commit();
        fm.beginTransaction().replace(R.id.main_container, videosFragment, "5").hide(videosFragment).commit();
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(HomeActivity1.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(HomeActivity1.this, errorMessage, Toast.LENGTH_LONG).show();
    ...
    private void updateToken() {
        ...
        Call<BannerData> call = service.processToken(jsonObject);
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
            = item -> {
             ...
             /*       case R.id.navigation_videos:
                        ...
                        fm.beginTransaction().replace(R.id.main_container,videosFragment, "5").commit();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.navigation_home) {
           ...
           Intent intent=new Intent(HomeActivity1.this,CropReportsListActivity.class);
           intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_CLEAR_TOP);
           startActivity(intent);

        }else if (id == R.id.navigation_videos) {
            Intent intent =new Intent(HomeActivity1.this, VideoMoreActivity.class);
    ...
    private void displayAddressOutput() {
        ...
        Log.d(TAG,""+jsonObject);
        ApiInterface service = RetrofitClientInstance.getRetrofitInstance().create(ApiInterface.class);
        Call<BannerData> call = service.processLocation(jsonObject);
        call.enqueue(new Callback<BannerData>() {
            @Override
            public void onResponse(@NonNull Call<BannerData> call, @NonNull Response<BannerData> response) {
    ...
    private class AddressResultReceiver extends ResultReceiver {
        ...
        /**
         *  Receives data sent from FetchAddressIntentService and updates the UI in HomeActivity1.
         */
        @Override
            ...
            showSnackbar(R.string.permission_rationale, android.R.string.ok,
                    new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(HomeActivity1.this,
