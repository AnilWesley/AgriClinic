...
public class CropsNamesActivity extends AppCompatActivity {
    ...
    public void getAllCrops(){
        ...
        pDialog = new ProgressDialog(CropsNamesActivity.this);
        ...
        jsonObject.addProperty("sub_category_id", subCat_id);
                    ...
                    if (cropsData.isStatus()){
                        if (cropsModalList != null&&cropsModalList.size()>0  ) {
                            for (int i = 0; i < cropsModalList.size(); i++) {
                                ...
                                cropsListAdapater = new CropsListAdapater(CropsNamesActivity.this, cropsModalList);

                                LinearLayoutManager linearLayoutManager = new LinearLayoutManager(CropsNamesActivity.this);
        ...
        binding.cropsRecycle.addOnItemTouchListener(new RecyclerItemClickListener(CropsNamesActivity.this,binding.cropsRecycle, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                ...
                bundle.putString("subCat_id",cropsModalList.get(position).getSub_category_id());
                bundle.putString("crop_id",cropsModalList.get(position).getId());
